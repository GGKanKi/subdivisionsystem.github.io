...
<body>
    ...
    <div class="account_main_bg">
        <div class="account_option">
            <div class="option_icons">
                ...
                <a href="search_house.php" target="_blank">
    ...
    <!-- SEND CONCERN/REPORTS -->
    <form action="account.php" method="POST" enctype="multipart/form-data">
        <div class="concern concern_font" id="concern">
        <p>ADDRESS YOUR CONCERN SENDING A LETTER.</p>
        <input type="text" class="input__box concern_font" name="concern" placeholder="Concern Point." required>
        <input type="file" name="pdfconcern">
            <div class="concern_button">
            <input type="submit" class="button" name="file_complaint" value="FILE COMPLAINT">
            <input type="button" class="button" name="close" id="close_resident" value="CLOSE">
            </div>
        </div>
    </form>
    <!-- SETTINGS FOR USER -->
